...
const VillageUmkm = () => {
    ...
    const { umkm, loading, error } = useVillageUMKM(); // Mengambil profil desa dari API
  ...
  return (
    <div className="py-16 font-sans">
      <div className="container mx-auto text-center px-4 md:px-8">
        <h2 className="text-4xl font-bold mb-9 text-gray-800">UMKM Desa Cibangkong</h2>
        ...
        {Array.isArray(umkm) && umkm.map((umkm, index) => (
            ...
            >
              ...
              <div className={`md:w-1/2 text-left md:ml-8 md:mr-8 mt-6 md:mt-0 ${index % 2 === 0 ? 'order-1' : 'order-2'}`}>
